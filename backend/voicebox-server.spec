...
datas += tmp_ret[0]; binaries += tmp_ret[1]; hiddenimports += tmp_ret[2]
# onnxruntime ships onnxruntime.dll + onnxruntime_providers_shared.dll under
# onnxruntime/capi/ — collect the whole package so the native DLLs are bundled.
